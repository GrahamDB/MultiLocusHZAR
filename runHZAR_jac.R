...
## place to find all data and script files
#setwd(file.path("~","Downloads","WCS-SNP-HZAR-local"))
setwd("~/Dropbox/Jacanas/Jacana_HZAR")
...
## (code currently use range of 0 to 1200)
source("params_jac_loci.R")
...
source("modelLoader_jac.R")

## Test Loci against Null Model
rebuild.tests <- FALSE
